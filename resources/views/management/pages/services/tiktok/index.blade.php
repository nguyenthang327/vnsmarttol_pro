                                    ...
                                    <div class="card form-group">
                                        ...
                                        <div class="card-body">
                                            <form id="formUserAction"
                                                  action="{{ route('api.service.tiktok', ['type' => $type]) }}">
                                                @if (in_array($type, ['like-tiktok','comment-tiktok', 'share-tiktok', 'view-tiktok']))
                                                    <div class="form-group">
                                                        <label for="link_post">Link bài viết</label>
                                                        <input type="url" class="form-control" id="link_post"
                                                               name="link_post"
                                                               placeholder="https://www.tiktok.com/@test/video/12345"
                                                               autocomplete="off" required>
                                                    </div>
                                                @elseif (in_array($type, ['sub-tiktok','eye-live-tiktok']))
                                                    <div class="form-group">
                                                        <label for="username">Link profile cần tăng follow</label>
                                                        <input type="text" class="form-control" id="username"
                                                               name="username"
                                                               onpaste="ttGetUsername('username');"
                                                               placeholder="https://www.tiktok.com/@testhihi"
                                                               autocomplete="off" required>
                                                    </div>
                                                @endif
                                                <div class="form-group">
                                                ...
                                                @if ($type == 'eye-live-tiktok')
                                                    <div class="form-group">
                                                        <label for="count">Số mắt</label>
...
@section('js_page')
    <script>
        ...
        function calculatorPrice(isToastr = true) {
            let form = $('#formUserAction');
            let count = form.find(`[name="count"]`).val();
            let minutes = form.find(`[name="minutes"]`).val();
            let selectedPrice = form.find(`input[name=price]`).val();
            let total = count * minutes * selectedPrice;
            ...
            setTimeout(() => {
                ...
                if (username) {
                    ...
                    $("[name=" + elm + "]")
                        .prop("disabled", false)
                        .val(username);
                    toastr.success("Lấy username thành công");
                } else {
                    $("[name=" + elm + "]")
                        .prop("disabled", false)
                        .val("");
