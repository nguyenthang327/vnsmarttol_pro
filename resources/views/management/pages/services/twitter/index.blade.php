                                    ...
                                    <div class="card form-group">
                                        ...
                                        <div class="card-body">
                                            <form id="formUserAction"
                                                  action="{{ route('api.service.twitter', ['type' => $type]) }}">
                                                @if ($type == 'like-twitter')
                                                    <div class="form-group">
                                                        <label for="link_post">Link bài viết vd: https://twitter.com/abc/status/123</label>
                                                        <input type="url" class="form-control" id="link_post"
                                                               name="link_post"
                                                               placeholder="https://twitter.com/abc/status/123"
                                                ...
                                                @if ($type == 'follow-twitter')
                                                    <div class="form-group">
                                                        <label for="username">Nhập link của tk vd:
                                                            https://twitter.com/profile</label>
                                                        <input type="text" class="form-control" id="username" name="username"
                                                               onpaste="twtGetUsername('username');"
