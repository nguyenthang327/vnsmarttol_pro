                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    <div class="card form-group">
                                        ...
                                        <div class="card-body">
                                            <form id="formUserAction" action="/fb_speed/s_like">
                                                <div class="form-group">
                                                    <input type="hidden" name="url" id="url" />
                                                    <label for="uid">ID hoặc link bài viết cần chạy</label>
                                                    <input type="text" class="form-control" id="uid"
                                                        name="uid"
                                                        placeholder="Hãy nhập đúng link, sai k có hoàn tiền"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="radio radio-server">
                                                        <label><input type="radio" name="server"
                                                                value="server_6">Server 6
                                                        </label>
                                                    </div>

                                                    <div class="radio radio-server">
                                                        <label><input type="radio" name="server"
                                                                value="server_1">Server 1
                                                        </label>
                                                    </div>

                                                    <div class="radio radio-server">
                                                        <label><input type="radio" name="server"
                                                                value="server_7">Server 7
                                                        </label>
                                                    </div>

                                                    <div class="radio radio-server">
                                                        <label><input type="radio" name="server"
                                                                value="server_9">Server 9
                                                        </label>
                                                    </div>

                                                    <div class="radio radio-server">
                                                        <label><input type="radio" name="server"
                                                                value="server_2">Server 2
                                                        </label>
                                                    </div>

                                                    <div class="item-child server-section server_2-visible"
                                                        style="display:none">

                                                        <div class="radio">
                                                            <label><input type="radio" name="speed_server_2"
                                                                    value="low" checked data-multiple="1">
                                                                Chậm
                                                            </label>
                                                        </div>
                                                        ...
                                                        <div class="radio">
                                                            <label><input type="radio" name="speed_server_2"
                                                                    value="high" data-multiple="2.5">
                                                                Nhanh (giá x2.5-Nên chọn)
                                                            </label>
                                                        </div>
                                                    </div>

                                                    <div class="radio radio-server">
                                                        <label><input type="radio" name="server" value="server_3">
                                                            Server 3
                                                        </label>
                                                    </div>
                                                    ...
                                                    <div class="radio radio-server">
                                                        <label><input type="radio" name="server"
                                                                value="server_5">Server 5
                                                        </label>
                                                    </div>

                                                    <div class="radio radio-server">
                                                        <label><input type="radio" name="server"
                                                                value="server_8">Server 8
                                                        </label>
                                                    </div>

                                                    <div class="radio radio-server">
                                                        <label><input type="radio" name="server"
                                                                value="server_10">Server 10
                                                        </label>
                                                    </div>

                                                    <div class="radio radio-server">
                                                        <label><input type="radio" name="server"
                                                                value="server_4">Server 4
                                                        </label>
                                                    </div>
                                                ...
                                                <div
                                                    class="form-group server-section server_1-visible server_2-visible server_3-visible server_6-visible">
                                                        ...
                                                        <div class="checkbox">
                                                            <label>
                                                                <input name="reaction" value="like" type="radio"
                                                                    required checked>
                                                                <img src="{{asset('/assets/images/fb-reaction/like.png')}}"
                                                        ...
                                                        <div class="checkbox">
                                                            <label>
                                                                <input name="reaction" value="love" type="radio"
                                                                    required>
                                                                <img src="{{asset('/assets/images/fb-reaction/love.png')}}"
                                                        ...
                                                        <div class="checkbox">
                                                            <label>
                                                                <input name="reaction" value="care" type="radio"
                                                                    required>
                                                                <img src="{{asset('/assets/images/fb-reaction/care.png')}}"
                                                        ...
                                                        <div class="checkbox">
                                                            <label>
                                                                <input name="reaction" value="wow" type="radio"
                                                                    required>
                                                                <img src="{{asset('/assets/images/fb-reaction/wow.png')}}"
                                                        ...
                                                        <div class="checkbox">
                                                            <label>
                                                                <input name="reaction" value="haha" type="radio"
                                                                    required>
                                                                <img src="{{asset('/assets/images/fb-reaction/haha.png')}}"
                                                        ...
                                                        <div class="checkbox">
                                                            <label>
                                                                <input name="reaction" value="sad" type="radio"
                                                                    required>
                                                                <img src="{{asset('/assets/images/fb-reaction/sad.png')}}"
                                                        ...
                                                        <div class="checkbox">
                                                            <label>
                                                                <input name="reaction" value="angry" type="radio"
                                                                    required>
                                                                <img src="{{asset('/assets/images/fb-reaction/angry.png')}}"
                                                    ...
                                                    <div class="form-group server-section server_2-visible text-danger">
                                                        Giá sẽ tăng thêm 5d khi bạn chọn cảm xúc (khác like) với server này
                                                    </div>
                                                </div>
                                                ...
                                                <div
                                                    class="form-group server-section server_1-visible server_6-visible server_7-visible server_9-visible">
                                                    <label for="speed">Tốc độ</label>
                                                    <select name="speed" id="speed" class="form-control" required>
                                                        <option value="0">Nhanh</option>
                                                        <option value="15">Trung bình</option>
                                                ...
                                                <div class="form-group">
                                                    <button id="submit" class="btn btn-success text-bold"
                                                        type="submit"><i class="fas fa-cart-plus"></i> Mua</button>
                                                </div>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <ul>
                                                <li><span style="color:#e74c3c">Hd <strong>lấy link</strong></span> 1 số
                                                    trường hợp mọi người hay sai.</li>
                                            </ul>
                                            ...
                                            <ol>
                                                ...
                                                <li>Lấy <strong>link dạng post cho video ( link n&oacute; chứa từ
                                                        post)</strong>&nbsp;<strong>:&nbsp;<a
                                                            href="https://prnt.sc/3hbTjFNcPwQz">Tại đ&acirc;y</a></strong>
                                                </li>
                                            ...
                                            <ul>
                                                ...
                                                <li>Nếu tăng 1 video trong <span style="color:#e74c3c">1 <strong>b&agrave;i
                                                        ...
                                                        1-6-7</span>. H&atilde;y test v&agrave; chọn sv 3-5-10</li>
                                                <li>Tất cả server đều KBH like khi tụt.</li>
                                            </ul>

                                            <p><span style="color:#e74c3c"><strong>C&aacute;c trường hợp hủy g&oacute;i
                                                        v&agrave; k l&ecirc;n like</strong></span></p>

                                            <ul>
                                                <li>b&agrave;i viết l&agrave; avatar , ảnh&nbsp;b&igrave;a h&atilde;y xem kỹ
                                                    video v&agrave; lấy link + bật n&uacute;t like.</li>
                                                <li>Nếu like <span style="color:#e74c3c">group </span>c&ocirc;ng khai
                                                    ,<span style="color:#e74c3c">video </span>v&agrave; <span
                                                        style="color:#e74c3c">livestream&nbsp;</span>h&atilde;y test sl nhỏ
                                                    trước, Dễ bị ẩn đơn 1 số server kh&ocirc;ng chạy được.</li>
                                                <li>B&agrave;i viết sai link hoăc b&agrave;i c&oacute; tag người bị block
                                                    t&iacute;nh năng fb sẽ ẩn.</li>
                                            </ul>
