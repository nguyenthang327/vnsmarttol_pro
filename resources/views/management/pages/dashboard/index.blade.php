...
@section('content')
        ...
        <div class="row flex-row-reverse">
            ...
            <div class="col-xl-8 col-md-6">
                ...
                <div class="card mb-2 box-shadow-1">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <img src="{{ asset('management/assets/images/admin.png') }}"
                                 class="feed-icon align-self-end"
                                 alt="">
                            <div>
    ...
    <div class="modal fade" id="lastNotifyModal" tabindex="-1" role="dialog" aria-modal="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="notify-content"><p><span style="color:#e74c3c"><strong>Chào mừng bạn tới website số 1 VN.<br>Cung cấp các giải pháp markerting digital</strong></span>
                        </p></div>
                    <div class="notify-image">
                        <img src="https://s3.ap-northeast-1.amazonaws.com/h.files/images/1639407050317_2RgcADA9Va.jpeg"
                             alt="">
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary btn-hide-notify" data-dismiss="modal">Không hiện
                        nữa
                    </button>
                </div>
            </div>
...
@section('js_page')
    ...
    <script>
        var lastNotify = 0;
        var newestNotifyId = "{{ $lastNotify->id ?? 0 }}";

        $(document).ready(function() {
            lastNotify = Cookies.get('last_notify') || 0;
            if (parseInt(newestNotifyId) !== parseInt(lastNotify)) {
                $('#lastNotifyModal').modal('show');
            }

            $('.btn-hide-notify').click(function() {
                Cookies.set('last_notify', newestNotifyId);
            });
