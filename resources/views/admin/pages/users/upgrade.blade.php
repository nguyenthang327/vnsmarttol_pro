...
@section('content')
    <div class="main-content">
        ...
        <div class="card" data-select2-id="6">
            <div class="card-header bg-primary">
                <h4 class="card-title text-white">Nâng cấp Thành Viên'</h4>
            </div>
            <div class="card-body" data-select2-id="5">
                <form id="formAdminAction" class="kt-form" method="POST" action="/qladmin/user/upgrade">
                    <div class="form-group" data-select2-id="4">
                        <label for="user_id">Chọn Tài Khoản</label>
                        <select class="form-control select2-hidden-accessible" id="user_id" name="user_id"
                                autocomplete="off" required="" data-select2-id="user_id" tabindex="-1"
                                aria-hidden="true">
                            <option></option>
