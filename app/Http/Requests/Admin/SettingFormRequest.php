...
class SettingFormRequest extends BaseFormRequest
{
    public function rules(): array
    {
        return [
            ...
            'total_charge_lv1' => ['nullable', 'string', 'max:255'],
            'min_charge_lv2' => ['nullable', 'string', 'max:255'],
            'total_charge_lv2' => ['nullable', 'string', 'max:255'],
            'min_charge_lv3' => ['nullable', 'string', 'max:255'],
            'total_charge_lv3' => ['nullable', 'string', 'max:255'],
            'offer_percent' => ['nullable', 'string', 'max:255'],
            'offer_from' => ['nullable', 'string', 'max:255'],
            'offer_to' => ['nullable', 'string', 'max:255'],
            'bank_prefix' => ['nullable', 'string', 'max:255'],
            'enable_referral' => ['nullable', 'string', 'max:255'],
            'referral_percent' => ['nullable', 'string', 'max:255'],
